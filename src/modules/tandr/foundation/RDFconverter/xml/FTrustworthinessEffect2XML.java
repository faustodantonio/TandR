...
public class FTrustworthinessEffect2XML {

	private HashMap<String, Namespace> namespaces;
//	private FEffect feffect;
	
	public FTrustworthinessEffect2XML() {
		super();
		this.namespaces = UConfig.namespaces;
	}
	
	public Element createTrustworthinessEffectElement(String classEffectUri, String value, String computedAt){
	...
	public Element createTrustworthinessAspectElement(String classAspectUri, String value, String computedAt){
		Element hasAspectElement = null, aspectElement = null, aspectType = null, aspectDescription = null, aspectValue = null;
		
		hasAspectElement = new Element("hasTrustworthinessAspect",this.namespaces.get("tandr"));
